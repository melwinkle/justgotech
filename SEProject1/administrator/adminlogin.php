...
<h1 style="margin-left: 100px">ADMINISTRATOR</h1>
...
<!-- Default form login -->
<form class="text-center border border-light p-5"style="border:none" method="post" action="alert.php">
    ...
    <!-- Register -->
    <p>Register a new admin?
        <a href="../administrator/adminreg.php">Register</a>
    </p>
...
<div>
<img style="width:40%;margin-left: 850px;margin-top: -400px"src="../images/hospital.png" alt=""></div>
