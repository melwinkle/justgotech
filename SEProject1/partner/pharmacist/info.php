             ...
             <div class='card  mb-4 shadow-sm '  style='background:#ffffff;height:600px;width:250%;border-radius:10px;color:rgb(4, 23, 75)'>
                    ...
                    <div style="margin-left:15%;margin-top:2%">
                      ...
                      <form action="update_in.php?id=<?php echo "Linux";?>" method="post">
                        ...
                        <input style="border:1px solid #3498db;border-radius:5px;width:80%;height:40px"type="text" name="user" id="user" value="<?php echo "Linux ";?>"readonly><br>



                        <label for="lname">Company Name</label><br>
                        <input style="border:1px solid #3498db;border-radius:5px;width:80%;height:40px" type="text" name="lname" id="lname" value="<?php echo "Linux Pharmacy";?>"><br>

                        <label for="dob">Location</label><br>
                        <input style="border:1px solid #3498db;border-radius:5px;width:80%;height:40px" type="text" name="dob" id="dob" value="<?php echo "Airport Residential Area";?>" readonly ><br>

                        <label for="gender">Mobile </label><br>
                        <input style="border:1px solid #3498db;border-radius:5px;width:80%;height:40px"type="text" name="gender" id="gender"  value="<?php echo "0240000000";?>"readonly><br>
