  ...
  <div id="myDropdown" class="dropdown-content">
    ...
    if($nn>0){
     while($num=mysqli_fetch_assoc($noq)){
       ...
       $mes=$num['NMessage'];
       $da=$num['NTime'];
       echo "<a href='../pharmacy/ph_suc.php?not&id=$nt&mprev=../pharmacy/pharmacy_main.php'>$mes $da</a>";
     }
    }else{
...
function cartP(){
  window.location.href="../pharmacy/ph_cart.php?mprev=../pharmacy/pharmacy_main.php";
}
</script>
</body>
<footer>
