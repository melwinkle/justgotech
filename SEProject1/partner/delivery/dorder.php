...
<div class="row">
    <div class="col-sm-4">    
            ...
            <div class='card  mb-4 shadow-sm '  style='background:white;height:150px;width:78%;border-radius:2px;color:#cccccc'>
                 <h2 style="margin-top:10px;color:skyblue;text-align:center"><img src="https://img.icons8.com/windows/64/3498db/packaging.png"/>5</h2>
...
<div class="col-sm-4">    
    ...
    <div class='card  mb-4 shadow-sm '  style='background:white;height:150px;width:78%;border-radius:2px;color:#cccccc'>
    <h2 style="margin-top:10px;color:skyblue;text-align:center"><img src="https://img.icons8.com/wired/64/3498db/get-cash.png"/>GHc 550</h2>
...
<button onclick="nec()" style="background:none;border:none"><img src="https://img.icons8.com/material-rounded/24/000000/menu-2.png"/></button>
</div>
...
<div style="margin-left:890px;margin-top:-10%">
<ul style=" list-style-type: none">
<li><img src="https://img.icons8.com/material-sharp/15/9b59b6/filled-circle.png"/>Delivered</li>
<li><img src="https://img.icons8.com/material-outlined/18/cccccc/mobile-payment.png"/>Mobile Money</li>
<li><img src="https://img.icons8.com/material-outlined/20/cccccc/average.png"/>Ghc 2</li>
...
<div style="margin-left:1050px;margin-top:-6%">
<button onclick="nec()" type="button" style="background:none;border:none"><img src="https://img.icons8.com/material-rounded/24/000000/menu-2.png"/></button>
</div>
