...
$query="INSERT INTO diseases(age_bracket,symptom,testing,disease_id,PatientID,Region,precon,Time,Status,Person,Exposure) VALUES ('$age','$sym','$test', '$disease', $PatientID, '$reg', '$pre','$time','$status','$person','$con')";
$result=mysqli_query($conn,$query);
if($result){
  $rid=mysqli_insert_id($conn);
    header("Location: malresult.php?rid=$rid&prob=$probability");
}
else{
    echo "Did not ho";
}
