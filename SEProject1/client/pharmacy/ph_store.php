  ...
  <div class="store">
    ...
    <div class="card-body" style="border:2px solid blue;width:80%;">
      <form class="fsearch" action="ph_info.php" method="post" style="margin-left:20px">
        <input type="text" name="drug" id="drug" placeholder="  Drug eg.Paracetamol" value="<?php if (isset($drug)) {
                                                                                              echo $drug;
                                                                                            } else {
                                                                                              echo "";
                                                                                            } ?>" style="width:48%;height:6%;">
        <input type="text" name="location" id="location" placeholder="  Location eg.Osu" value="<?php if (isset($location)) {
                                                                                                  echo $location;
                                                                                                } else {
                                                                                                  echo "";
                                                                                                } ?>" style="margin-left:40px;width:45%;height:6%;"><br>
