...
if(isset($_GET['edit'])){
    ...
    $bkd="SELECT firstname,lastname,PresDesc,Drugdesc from Prescriptions inner join booking on Prescriptions.BID=booking.BID inner join customer on booking.PatientID=customer.PatientID where PresID=$bd ";
...
<a style="color:rgb(4, 23, 75);font-size:18pt"href="../doctor/diagnosis.php"><img src="https://img.icons8.com/metro/26/3498db/lock-2.png"/>BACK</a>
</div>
    <div class="row">
        <div class="col-sm-4">    
             <div class='card  mb-4 shadow-sm '  style='background:#ffffff;height:600px;width:250%;border-radius:10px;color:rgb(4, 23, 75)'>
                    ...
                    <div style="margin-left:10%;margin-top:2%">
                      ...
                      <form action="notify.php?bc=<?php echo $bd;?>" method="post">
                        ...
                        <textarea  style="border:1px solid #3498db;border-radius:5px;" name="pre" id="pre" cols="130" rows="5"><?php echo $di;?></textarea><br>
                        

                       
                        <label for="lname">Prescription</label><br>
                        <textarea  style="border:1px solid #3498db;border-radius:5px;" name="drug" id="pre" cols="130" rows="5" ><?php echo $dr;?></textarea><br>
                        
                    

                        <button name="updi"type="submit" style="margin-top:5%;margin-left:20%;width:40%;height:20%;background:rgb(4, 23, 75)"class="btn btn-primary">UPDATE</a>
                        </form>
                    </div>
                </div>
         </div>
