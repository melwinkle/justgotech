...
<body>
  ...
  <div class="row" style="margin-left:14.5%">
    <span style="margin-top:2.5%;margin-bottom:-55px">
      <h2 style="text-align:left;margin-left:40px">VIRTUAL SCREENING</h2>
    </span>
    ...
    <span style="margin-top:1%;margin-bottom:-55px">
      <h2 style="text-align:left;margin-left:40px">CONSULTATION</h2>
    </span>
    ...
    <div class="column" style="width:1200px">
      <div class="card  mb-4 shadow-sm " style="height:250px;color:white;background:#3478db;">
        ...
        <span style="margin-top:50px;margin-left:35px; padding-top:30px">
          <h3 style="text-align:left">UPCOMING</h3>
        </span>
        <span style="margin-top:-40px;margin-left:800px">
          <h1><?php echo $upn; ?></h1>
        </span>

        <span style="margin-top:50px;margin-left:35px">
          <h3 style="text-align:left">COMPLETED</h3>
        </span>
    ...
    <span style="margin-top:1%;margin-bottom:-55px">
      <h2 style="text-align:left;margin-left:40px">PHARMACY</h2>
    </span>
    ...
    <div class="column" style="width:1200px">
      <div class="card  mb-4 shadow-sm " style="height:250px;color:white;background:#3478db;">
        ...
        <span style="margin-top:50px;margin-left:35px; padding-top:10px">
          <h3 style="text-align:left">ITEMS IN CART</h3>
        </span>
        <span style="margin-top:-40px;margin-left:800px">
          <h1><?php echo $pn; ?></h1>
        </span>
