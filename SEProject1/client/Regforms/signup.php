...
<body>
	...
	<div class="wrapper" style="background-image: url('images/bg-registration-form-1.jpg'); display: grid; place-content: center;">
		...
		<div class="inner" style="margin: 40px;">
...
<?php 
	...
	if(isset($_POST['submit'])){
		...
		$sql = "INSERT INTO heroku_c9b858a1f702a48.customer(`firstname`, `lastname`, `username`, `email`, `gender`, `dob`, `nationality`, `phonenumber`, `userpassword`, `precustomer`) VALUES('$firstname', '$lastname', '$username', '$email','$gender', '$dob', '$nationality', '$telephone', '$userpassword', '$precustomer', 'None')";
		...
		if($result) {
			...
			echo "<script>alert('Problem Registering Account');</script>";
		}
	}
?>